...
const status = [
  ...
  { p: "3", scope: "Autopilot bridge (sole PX4 boundary, uXRCE-DDS)", state: "Code complete + unit-tested; SITL pending", tone: "prog" },
  { p: "4", scope: "Guidance — Bayesian map, search, orbit-on-detect", state: "Code complete + unit-tested; SITL pending", tone: "prog" },
  { p: "5", scope: "Perception — Cam3 → Hailo detector → geolocation", state: "Code complete; .hef + SITL pending", tone: "prog" },
  { p: "6", scope: "Mission — state machine, failsafes", state: "Code complete + unit-tested; SITL pending", tone: "prog" },
      ...
      <main id="top" className="flex-1">
        ...
        <section id="status" className="border-b border-line bg-surface/40">
          <div className="mx-auto max-w-6xl px-6 py-20">
            ...
            <h2 className="max-w-3xl text-4xl font-semibold tracking-tight text-primary sm:text-5xl">
              7 packages build green. Nothing is sim-verified yet.
            </h2>
            <p className="mt-4 max-w-2xl text-secondary">
              All seven packages build green (colcon 8/8 on ROS 2 Humble), the
              full stack launches from one file, and 44/44 unit tests pass. The
              critical path now is the SITL campaign itself.
            </p>
